...
public class SubjectsCSD {
    ...
    public ArrayList<Subject> GetSubjects() {
        ...
        Subject subjectFP = new Subject("Fundamentos de Programacion", "1243", 6, 1);
        Subject subjectFIS = new Subject("Fundamentos de Ingenieria de Software", "1534", 4, 1);
        Subject subjectPOO = new Subject("Programación Orientada a Objetos", "2837", 8, 2);
        Subject subjectEDD = new Subject("Estructura de Datos", "3612", 6, 3);
        ...
        Subject subjectPW = new Subject("Programación Web", "4762", 6, 4);
        Subject subjectMPDS = new Subject("Modelos de Procesos de Desarrollo de Software", "4526", 4, 4);
        Subject subjectSBD = new Subject("Sistemas de Bases de Datos", "4162", 6, 4);
        Subject subjectIU = new Subject("Ingenieria de Usabilidad", "4213", 4, 4);
        Subject subjectCP = new Subject("Computación Paralela", "4619", 4, 4);
        //---------
        Subject subjectSABD = new Subject("Sistemas Avanzados de Bases de Datos", "5987", 6, 5);
        ...
        Subject subjectCG = new Subject("Computacion Grafica", "5000", 4, 5);
        Subject subjectIIS = new Subject("Investigacion en la Ingenieria de Software", "5803", 4, 5);
        Subject subjectRC = new Subject("Redes de Computadores", "5209", 4, 5);
        Subject subjectABC = new Subject("Aplicaciones Basadas en el Conocimiento", "6890", 6, 6);
        Subject subjectPS = new Subject("Pruebas de Software", "6127", 4, 6);
        ...
        Subject subjectDAM = new Subject("Desarrollo de Aplicaciones Moviles", "6336", 4, 6);
        //---------
        ...
        Subject subjectDSS = new Subject("Desarrollo de Software Segurp", "7456", 4, 7);
