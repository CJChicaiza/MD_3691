...
public class SubjectsCSD {
    ...
    public ArrayList<Subject> GetSubjects() {
        ...
        Subject subjectFIS = new Subject("Fundamentos de Ingenieria de Software", "1534", 4, 1,"Ingenieria Software");
        ...
        Subject subjectCD = new Subject("Computación Digital", "4527", 6, 4,"Desarrollo Web");
        ...
        Subject subjectIU = new Subject("Ingenieria de Usabilidad", "4213", 4, 4,"Ingeniera Software");
        Subject subjectCP = new Subject("Computación Paralela", "4619", 4, 4,"Programacion");
        //---------
        Subject subjectSABD = new Subject("Sistemas Avanzados de Bases de Datos", "5987", 6, 5,"Bases de datos");//Bases de datos
        Subject subjectDWA = new Subject("Desarrollo Web Avanzado", "5812", 6, 5,"Desarrollo Web");
        Subject subjectRS = new Subject("Ingenieria de Requisitos de Software", "5253", 6, 5,"Ingenieria Software");
        Subject subjectCG = new Subject("Computacion Grafica", "5000", 4, 5,"App Graficas");
        Subject subjectIIS = new Subject("Investigacion en la Ingenieria de Software", "5803", 4, 5,"Investigacion Software");
        Subject subjectRC = new Subject("Redes de Computadores", "5209", 4, 5,"App Graficas");
        Subject subjectABC = new Subject("Aplicaciones Basadas en el Conocimiento", "6890", 6, 6,"Bases de datos");
        Subject subjectPS = new Subject("Pruebas de Software", "6127", 4, 6,"Programacion");
        Subject subjectADS = new Subject("Analisis y diseno de Software", "6699", 4, 6,"Arquitectura Software");
        Subject subjectSO = new Subject("Sistemas Operativos", "6070", 4, 6,"App Graficas");
        Subject subjectLETA = new Subject("Lectura y Escritura de Textos Academicos", "6329", 4, 6,"Investigacion Software");
        Subject subjectDAM = new Subject("Desarrollo de Aplicaciones Moviles", "6336", 4, 6,"App Moviles");
        //---------
        Subject subjectACS = new Subject("Aseguramiento de la Calidad de software", "7410", 4, 7,"Investigacion Software");
        Subject subjectAD = new Subject("Aplicaciones Distribuidas", "7852", 4, 7,"App moviles");
        Subject subjectISS = new Subject("Ingenieria de la seguridad del Software", "7963", 4, 7,"Software");
        Subject subjectDV = new Subject("Desarrollo de Videojuegos", "7123", 4, 7,"App Moviles");
        Subject subjectDSS = new Subject("Desarrollo de Software Seguro", "7456", 4, 7,"Software");
        Subject subjectCES = new Subject("Construccion y Evolución del software", "8410", 4, 8,"Arquitectura Software");
        Subject subjectAS = new Subject("Arquitectura de software", "8789", 4, 8,"Arquitectura Software");
        Subject subjectDSADI = new Subject("Desarrollo de software aplicado al Dominio de la Interculturalidad", "7531", 4, 8,"Software");
